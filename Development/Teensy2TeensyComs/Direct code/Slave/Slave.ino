...
// Global position
float A5_Pos;                     // Actual position of A5 (mm)
volatile long A5_encoderPos = 0;  // encoder Pos (counts)
bool A5_Homed = false;            // axis homed?
int A5_HomeOffset = 110;          // What is the homing pos offset value (mm)
int A5_Max = A5_HomeOffset+1;     // What is the max pos (mm)
int A5_Min = 0;                   // What is the min pos (mm)
double A5_cpmm = 80;              // encoder counts per mm of motion
// Active control
